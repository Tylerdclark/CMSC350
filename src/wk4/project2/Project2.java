 ...
 * Description: This is the main class/driver of project2. This file reads a text file using JFileChooser and
 * creates polynomial objects with each line in the text file. The Polynomial objects are places in a list which
 * checks if the objects are in strong and weak order. */
